...
//查询用户最新的数据集
export const getLastHousesByUserId = query => {
    return request({
        url: `${_this.$serverUrl}getLastHousesByUserId`,
        method: 'post',
        data: query
    });
};
...
//用户查询最新模型信息
export const getNewestRoomByUserId = query => {
    return request({
        url: `${_this.$serverUrl}getNewestRoomByUserId`,
        method: 'post',
        data: query
    });
};
